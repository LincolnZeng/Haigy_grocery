...
namespace :haigy_cordova do
  ...
  task deploy: :environment do
    ...
    if File.directory?(cordovaAppPath)
      ...
      puts "Error: Cannot locate cordova app for this project. Please set a correct cordova path in the file \"config/haigy_client.yml\" as: cordova_app_path: \"/Example/Cordova/App/Path\""
    end
  end
