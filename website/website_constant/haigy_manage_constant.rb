...
module HaigyManageConstant
  ...
  module Business
    BASIC_DELIVERY_FEE = HAIGY_SETTINGS["basic_delivery_fee"] || 2.99
    DELUXE_DELIVERY_FEE = HAIGY_SETTINGS["deluxe_delivery_fee"] || 4.99
  ...
  module Stripe
    SECRET_KEY = HAIGY_SETTINGS["stripe_secret_key"] || "sk_test_key"
    PUBLISHABLE_KEY = HAIGY_SETTINGS["stripe_publishable_key"] || "pk_test_key"
  end
  ...
  module Error
    ...
    PERMISSION_REQUIRED = {code: 40003, http_status: :not_acceptable}
    SIGN_IN_REQUIRED = {code: 40004, http_status: :not_acceptable}

    # order
    ZIPCODE_NOT_SERVABLE = {code: 50001, http_status: :not_acceptable}
    ITEM_INFO_OUTDATED = {code: 50002, http_status: :not_acceptable}
    STRIPE_PAYMENT_FAILED = {code: 50003, http_status: :not_acceptable}

    # action
    ACTION_TOO_FREQUENTLY = {code: 60001, http_status: :not_acceptable}

    #other
    NOT_ALLOWED = {code: 70001, http_status: :not_acceptable}
  end
