modulejs.define("view/brief_info_item/collection_base_class", [
  ...
  utility, cartHelper, userModalsigninViewDef
) {
  "use strict";
  ...
  var briefinfoitemCollectionbaseclassView = Backbone.View.extend({
    ...
    userConfirmT: JST["template/main/_user_confirm"],
    ...
    addToCart: function(event) {
      ...
      cartHelper.setActionForEachCartStatus(
        function() {   // actionForNoZipCode
          that.confirmUser(null);
        },

        null,   // actionAfterLongIdle
    ...
    removeFromCart: function(event) {
      ...
      cartHelper.setActionForEachCartStatus(
        ...
        function() {   // normalAction
          var itemId = button.data("itemId");
          cartHelper.subtractItemQuantity(itemId, function() {
            var itemCartOperationContainer = that.$([".biitem-cbc-item-extra-content-", itemId].join(""));
            itemCartOperationContainer.empty();
            itemCartOperationContainer.append(that.itemCartOperationT({
              itemId: itemId,
    ...
    confirmUser: function() {
      this.destroyCurrentUserConfirmModal();
      this.userSigninModal = new userModalsigninViewDef({showZipCodeForm: true});
    ...
    destroyCurrentUserConfirmModal: function() {
