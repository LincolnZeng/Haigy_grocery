class UserAddress < ActiveRecord::Base
  ...
  def generateInputAddress
    addressPart = [self.input_street_address]
    unless self.input_apt_number.empty?
      addressPart << ["# ", self.input_apt_number].join("")
    end
    addressPart << self.input_zip_code
    self.input_address = addressPart.join(", ")
  end
end
