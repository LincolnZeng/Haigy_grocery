 ...
 */
- (void)setTorchOffButtonAccessibilityLabel:(NSString *)label hint:(NSString *)hint;
 ...
 * \param hint The accessibility hint.
 */
- (void)setTorchOnButtonAccessibilityLabel:(NSString *)label hint:(NSString *)hint;
 ...
 * \param hint The accessibility hint.
 */
- (void)setCameraSwitchButtonBackAccessibilityLabel:(NSString *)label hint:(NSString *)hint;
 ...
 * \param hint The accessibility hint.
 */
- (void)setCameraSwitchButtonFrontAccessibilityLabel:(NSString *)label hint:(NSString *)hint;
